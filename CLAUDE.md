...
| **Current Phase** | **W04 MERGED**（PR #34, `5bb0c9f`）— M1 slice 1；ADR-0012 拍板（`users` 全域無 `org_entity_id`）、`Policy` base fields 6→1、伺服器端發號。**形狀已可複製，其餘 32 張表是 slice 2..N** |
...
| [`docs/14-adr/`](./docs/14-adr/README.md) | ⭐ 架構決定記錄 —— **0001 / 0004 / 0005 / 0007 / 0010 / 0011 / 0012 已採納（0006 已被 0010 取代）；0002 / 0003 待 spike，0008 / 0009 待 Wave 3** |
...
**Last Updated**: 2026-08-10（W04 closeout）
