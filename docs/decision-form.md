...
> ⚠️ **剩下四項的「誰能決定」仍未指定。** 2026-08-07 使用者拍板了技術類三項（OQ-1 / 2 / 5，
> 見下方已拍板），**OQ-3 於 2026-08-09 由 W02 spike 拍板**（不是 W01）；剩下的 OQ-4 / 6 / 7
> 同樣要等 spike 的實測結果 —— OQ-4 的落點是 M3 稽核軌跡（[`0004`](./14-adr/0004-entity-scoping-enforcement.md)
> §Consequences：攔截點與 entity-scope 共用），OQ-8 屬 Wave 3。
