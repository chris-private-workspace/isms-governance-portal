...
**Created**: 2026-08-07
**Last Reviewed**: 2026-08-13（W09 closeout —— R4 更新（12 → 15 張表；**第一個資料庫強制的職責分離，而它的變更沒有稽核**），其餘七條逐條看過無變化）
**Status**: Active
