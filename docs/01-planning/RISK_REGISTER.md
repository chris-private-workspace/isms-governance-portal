...
**Created**: 2026-08-07
**Last Reviewed**: 2026-08-13（W10 closeout —— R4 更新（15 → 17 張表；**第一張不可變的受控交付物，而誰發了哪一版沒有記錄**），其餘七條逐條看過無變化）
**Status**: Active
