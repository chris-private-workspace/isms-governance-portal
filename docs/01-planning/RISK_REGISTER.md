...
**Created**: 2026-08-07
**Last Reviewed**: 2026-08-14（W11 closeout —— R4 更新（17 → 18 張表；**稽核員第一份會讀的 ISO 27001 文件，而誰核准了排除無法證明**），其餘七條逐條看過無變化）
**Status**: Active
