...
**執行結果（預測 commit `874309f` 之後跑）—— ⭐ 4/4 方向全中，逐字相符**：
...
### 3.2 執行結果 —— 逐項對照（預測 commit `54a509a`）
...
| Day | 窗口 | Actual |
|-----|------|--------|
| Day 0 | `b469623` 22:48:06 → `77d0a4d` 23:08:49 | **20.7 min** |
| Day 1 | → `2712863` 23:28:48 | **20.0 min** |
| Day 2 | → `9aa5eb8` 23:53:04 | **24.3 min** |
| Day 3 | → `73f4d9b` 00:19:24 | **26.3 min** |
| Day 4 | `CH-030` mtime 12:00:27 → `25ce0e6` 12:28:27 | **28.0 min** |
...
`73f4d9b` → `25ce0e6` 之間有 **729 分鐘**，因為 phase 跨夜、Day 4 是使用者隔天啟動的。
