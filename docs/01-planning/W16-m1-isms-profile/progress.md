...
Day 0 commit：`5df66ea`（author date `2026-08-16T17:59:33+08:00`）
...
| 2.2 int spec（10 條 + 一次修正 + collation 加固）| `10:26:00Z` | `10:31:17Z` | **~5 min** | ⚠️ commit 導出（`21eaf03`）|
| 2.3 中性化 ×5（含一次汙染重跑）| `10:33:37Z` | `11:01:34Z` | **~28 min** | ⚠️ commit 導出（`c56ee8d`）|
...
| 3.x full gate 十三項重跑 | `11:08:00Z` | `11:11:38Z` | **~4 min** | ⚠️ commit 導出（`4fe7482`）|
