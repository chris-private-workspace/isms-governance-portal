...
| `pattern-reuse-feature` | 0.50 | n/a (3 pt, **跨 0.23~0.84**) | KEEP (W09 窗口 **0.50 UNDER**，四段皆 commit-to-commit 閉合但各含量不到的等待前綴 → 上界非工時; ⭐ 新估法首次對照成功: 預測 64 min vs 實測上界 58.5; 三點分散不是雜訊是**定義未收斂**, 定義穩前調乘數只是藏問題; → calibration-log) |
