...
| `greenfield-feature` | **0.45** | 0.46 / 0.29 (2 pt) | **RE-POINT 0.55→0.45** (W26 ratio **0.29 UNDER**, 第 2 點, 判準**字面觸發**; ⚠️ actual **推估非計時** —— commit 跨距 1.9 hr + closeout, 見 `AD-EstimateActualNotTimed-1`; ⛔ `actual/bottom-up` **0.162** 使該序列**不再單調**, 但論證不依賴單調; → calibration-log) |
