...
| `pattern-reuse-feature` | 0.50 | n/a (1 pt, **定義受污染**) | KEEP (W05 ratio 0.71 IN band **僅在修正定義下**; 字面定義給 2.19 —— branch base 是前一 phase 的 closeout 而中間跨了一夜; 修好定義前本點不可與未來的點併入同一窗口 → `AD-CalibrationMetric-2`; → calibration-log) |
